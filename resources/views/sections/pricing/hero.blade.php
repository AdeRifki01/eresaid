...
<section class="pricing-hero text-center">
    <!-- Background Grid -->
    <div class="pricing-hero-grid"></div>
    ...
    <div class="container hero-content">
        ...
        <div class="hero-pills reveal reveal-delay-3">
            <a href="#bundling" class="hero-pill">
            ...
            <a href="#photoshot" class="hero-pill">
